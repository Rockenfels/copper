...
Dog.create(name: "fido", breed: "lab", age: 5, gender: 'Male', description: "Ruff", owner_id: owner1.id)
Dog.create(name: "oscar", breed: "pug", age: 2, gender: 'Female', description: "actually", owner_id: owner1.id)
Dog.create(name: "rufus", breed: "corgi", age: 5, gender: 'Male', description: "No stay out of that!", owner_id: owner2.id)
Dog.create(name: "odie", breed: "beagle", age: 2, gender: 'Female', description: "Happy Man", owner_id: owner2.id)
